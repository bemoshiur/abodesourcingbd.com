...
/**
 * The Home H1 with its key words styled: the company name in the brand green, Bangladesh with an
 * animated colour sweep, India in the brand gradient. The text stays one continuous heading for
 * crawlers and screen readers, and the styling follows whatever wording the CMS holds — so the
 * owner can rewrite the headline in /admin without touching code.
 */
